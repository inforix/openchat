...
import { createBotForHost, useClientShell } from "../../../../../src/lib/client-protocol";

type NewBotPageProps = {
  hostId?: string;
};

export function NewBotPage({ hostId }: NewBotPageProps) {
...
export default function NewBotRoutePage({
  ...
  return <NewBotPage hostId={params.hostId} />;
}
